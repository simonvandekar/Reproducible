 ...
 * Be sure to pay attention to homebrew output to be sure installation proceeds correctly.
...
I am not an expert in reproducible methods and am actively learning the best way to do reproducible research using R Markdown, Git, and Docker.
